        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="section-title mt-4">
              A fully working Calendly alternative
            </h2>
      ...
      <section className="-mx-8 px-8 py-24 bg-slate-50 border-t border-gray-100">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {stack.map(({ icon: Icon, name, description }) => (
            <div
              key={name}
              className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex gap-4 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group"
            >
